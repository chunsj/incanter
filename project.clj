(defproject incanter "1.9.2-SNAPSHOT"
  ...
  :dependencies [[incanter/incanter-core "1.9.2-SNAPSHOT"]
                 [incanter/incanter-io "1.9.2-SNAPSHOT"]
                 [incanter/incanter-charts "1.9.2-SNAPSHOT"]
                 [incanter/incanter-mongodb "1.9.2-SNAPSHOT"]
                 [incanter/incanter-pdf "1.9.2-SNAPSHOT"]
                 [incanter/incanter-svg "1.9.2-SNAPSHOT"]
                 [incanter/incanter-latex "1.9.2-SNAPSHOT"]
                 [incanter/incanter-excel "1.9.2-SNAPSHOT"]
                 [incanter/incanter-sql "1.9.2-SNAPSHOT"]
                 [incanter/incanter-zoo "1.9.2-SNAPSHOT"]
                 [swingrepl "1.3.0"]
